...
Ingat saja empat zona ini, dan semua kata penunjuk akan jadi gampang. Sistem ini lalu dibagi lagi menjadi beberapa "keluarga" tergantung akhiran katanya.
...
#### **4. Keluarga JENIS (`こんな`, `そんな`, `あんな`, `どんな`)**
