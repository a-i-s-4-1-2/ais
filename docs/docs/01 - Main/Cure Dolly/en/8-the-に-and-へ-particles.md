...
- `(zeroが)おみせにたまごをかいにいく` → (Saya) pergi ke toko **untuk membeli** telur.
...
Jadi, `へ` hanya bisa menandai tempat yang **akan kamu tuju**, tidak bisa menandai tempat di mana kamu **sudah berada**.
